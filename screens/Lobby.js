...
export default function Lobby({ gameId, isHost, onBack, userId }) {
    ...
    const handleStartGame = async () => {
        ...
        try {
            ...
            setLoading(false);
            Alert.alert("Error", error.message || "Failed to assign missions and start operation.");
        }
    };
    ...
    return (
        ...
        >
            ...
            <View style={styles.qrSection}>
                <GameQR gameId={gameId} gameName={game?.name} size={125} />
                {!isHost && (
